...
def findOptimalG3(thread, X1, xpr_path=XGYMR_XPR, cache_dir=save_pt, dll_path=Dll_path, G3_distinct=0.3, G3_scale=1, G3_step=2, symmetry_step=2, symmetry_scale=1, ratio=-1):
    ...
    thread.show()
    thread.stop()
    return positive * original_G3, nmax, abs_k, int(positive*original_G3 * ratio)
